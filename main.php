...
<body data-bs-theme="dark">
    <div class="header">
    <header>
        <img src="Screenshot_20230720_191453_Chrome.jpg" alt="">
    ...
    <nav>
        <ul>
            ...
            <li><a class="con" href="#foot">Contact</a></li>
            <li><a class="log" href="login.php">login</a></li> 
            <li><a class="reg" href="register.php">Signup</a></li>
...
<div class="pa3">
    ...
    <img class="i9" src="7.png" alt="" >
</div>
<div class="pa4">
    <img class="i10" src="8.png" alt="">
...
<div class="pa3">
    ...
    <img class="i13" src="12.png" alt="" >
</div>
<div class="pa4">
    <img class="i10" src="15.png" alt="">
...
<img src="Logo_of_Twitter.svg.webp" alt="" class="i3">
</a>
<a href="https://www.linkedin.com/in/atharv-maske-61a983257">
<img src="LinkedIn_logo_initials.png.webp" alt="" class="i4">
</a>
<img src="Gmail_icon_(2020).svg.webp" alt="" class="i5">
